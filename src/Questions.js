const Questions = {
  ...
  basicConfiguration: [
    ...
    { q:'Secure user EXEC mode - via console port', a: '>line console 0, >password password, >login', tag: 0},
    { q:'Secure access via network (using ssh or telnet). VTY lines are 0 through 4. Password is "cisco", require users to login', a: '>line vty 0 4, >password password, >login', tag: 0},
    ...
    { q:'Destination Unreachable codes for ICMPv6', a: '0 - No route to destination<br>1 - Communication with the destination is administratively prohibited (e.g., firewall)<br>2 – Beyond scope of the source address<br>3 - Address unreachable<br>4 - Port unreachable', tag: 0},
